...
- **Active vs. Simulated Ingest Paths:** Raw CSV upload and Natural Language prompt extraction represent fully functional paths. Ingestion endpoints for Postgres DB and AWS S3 are mock-implemented as prototype concepts to demonstrate future connection architectures, which will be connected to live databases and bucket storage in the near future.
